...
">{lang === "TH" ? "สอบถามคิว" : "Commission Queue"}</a>
              ...
              <div className="bottombar flex pr-8 px-4 gap-6 p-4 flex items-center justify-center">
                {/* Facebook */}
                <a
                  href="https://www.facebook.com/mo.kochakorn"
                ...
                {/* Twitter */}
                <a
                  href="https://x.com/Mochii_roi"
                  className="text-white hover:text-sky-500 transition"
                >
                  <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current">
                ...
                {/* Instagram */}
                <a
                  href="https://www.instagram.com/_moshi_kch"
      ...
      100 2.2 1.1 1.1 0 000-2.2z"
              ...
              <div className="sidebar flex justify-center gap-4 p-4">
                <button
                  onClick={toggleLang}
                  className="py-1 px-4 rounded-lg border border-gray-400 text-white 
               hover:bg-gray-200 transition  hover:text-gray-800
               "
                >
                  {lang}
                </button>
